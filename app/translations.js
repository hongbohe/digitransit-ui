...
const translations = {
  'cn': {
    'about-this-service': '关于这个服务',
    'accessibility': '无障碍设施',
    'add-itinerary-via-point': '通过点创建行程',
    'add-location': '添加地址',
    'add-location-to-favourites': '添加重要地址到你的收藏夹',
    'address': '地址',
    'address-or-stop': '地址或者车站',
    'agency': '操作员',
    'airplane-with-route-number': '航班{routeNumber}',
    'airport-check-in': '在{agency}办理登机手续',
    'airport-collect-luggage': '取行李',
    'airport-security-check-go-to-gate': '通过安全检查去登机口',
    'approx-meters': '{approxDistance}米',
    'arriving-at': '到港',
    'arriving-soon': '现在',
    'avoid-transfers': '避免换乘',
    'avoid-walking': '避免走路',
    'back-to-front-page': '回到首页',
    'bike-availability': '车站现在有自行车',
    'bike-availability-short': '自行车',
    'bus-with-route-number': '公交车 {routeNumber} {headSign}',
    'buy-ticket': '如何购票',
    'call': '电话',
    'cancel': '取消',
    'car-distance-duration': '开车 {distance} ({duration})',
    'cause': '原因',
    'char-left': '字符',
    'choose-stop': '选择车站',
    'citybike': '城市自行车',
    'citybike-register-required': '要使用城市自行车，您需要注册',
    'close': '关闭',
    'contact-information': '联系方式 {contactName}',
    'create-account': '创建账号 {contactName}',
    'cycle-distance-duration': '循环 {distance} ({duration})',
    'cyclewalk-distance-duration': '骑自行车 {distance} ({duration})',
    'datasources': '数据源',
    'delete': '删除',
    'departure-time-in-minutes': '{minutes}分钟',
    'departures': '出港',
    'description': '查找公共交通工具到附近和远处。',
    'destination': '目的地',
    'destination-placeholder': '输入目的地，路线或车站',
    'digitransit-platform': 'Digitransit 平台',
    'disruption-info': '中断信息',
    'disruption-info-no-alerts': '未知的中断或转移.',
    'disruption-info-route-no-alerts': '路线没有已知的干扰或转移。',
    'disruptions': '中断',
    'distance-between': '距离{distance1}—{distance2}米',
    'distance-under': '距离小于{distance}米',
    'earlier': '早些时候',
    'edit-favourites': '编辑收藏夹中的地址',
    'extra-info': '更多信息',
    'favourite-target': '喜欢的地址',
    'ferry-with-route-number': '渡船 {routeNumber} {headSign}',
    'footer-feedback': '提交反馈',
    'footer-link-to-old': '旧版旅程计划链接',
    'footer-link-to-privacy-policy': '隐私政策',
    'frontpage': '首页',
    'geolocate-yourself': '检测你的地址',
    'give-destination': '输入你的目的地',
    'give-name-to-location': '给地点一个描述性的名字',
    'give-origin': '输入你的起始点.',
    'give-position': '在搜索框中输入你的地址或者起始点',
    'hour-short': '时',
    'how-to-rate-service': '你如何评价服务?',
    'in-addition': '此外',
    'inquiry': '你如何找到新版的旅程计划？请告诉我们!',
    'instructions': '说明',
    'itinerary-feedback-button': '发送反馈',
    'itinerary-feedback-message': '找不到你要找的东西?',
    'itinerary-feedback-placeholder': '说明(可选)',
    'itinerary-hide-stops': '隐藏车站',
    'itinerary-page.description': '行程',
    'itinerary-page.title': '行程',
    'itinerary-summary-page.description': '路线建议',
    'itinerary-summary-page.title': '路线建议',
    'later': '后来',
    'leaves': '离开',
    'leaving-at': '离开',
    'likely-to-recommend': '你愿意推荐我们的服务给你的朋友或同事吗?',
    'likely-to-use': '你愿意使用这项服务而不是目前的旅程计划吗？',
    'loading': '载入中...',
    'locate': '检测位置',
    'location-examples': 'e.g. 家, 工作, 学校,...',
    'location-from-map': '所选地址',
    'login': '登陆',
    'long-transfers-margin': '12 分钟',
    'main-menu-label-open': '打开主菜单',
    'main-mode': '我正在旅行',
    'map': '地图',
    'messagebar-label-close-message-bar': '关闭横幅',
    'messagebar-label-page': '页',
    'minute-short': '分',
    'minutes': '分钟',
    'navigate': '导航',
    'near-you': '在你附近',
    'nearest': '最近的',
    'next': '下一个',
    'no-favourite-locations': '在这里添加最常用的地址，这些按钮将直接规划你的路线。',
    'no-favourites': '使用星形按钮将路线或车站添加到你的收藏夹，你的收藏夹显示在此页面上。',
    'no-position': '没有地址',
    'no-position-no-stops': '你的地址不可用，我们无法显示最近的车站',
    'no-route-msg': '不幸的是没有找到你的旅程的路线，请更改你的起始地址或目的地址。',
    'no-route-start-end': '请选择起点和目的地。',
    'no-transfers-margin': '1分钟',
    'no-trips-found': '找不到所选日期的旅程。',
    'not-implemented': '{name}功能尚不可用',
    'not-implemented-msg': '如果你想参与开发工作，请使用以下链接了解规划中的功能更多信息。',
    'now': '现在',
    'number-of-intermediate-stops': '{number, plural, =0 {No stops} 1 {1 stop} 其他 {{number} stops} }',
    'off-canvas-info': '登录服务以保存你的收藏夹并将其用于其他设备。',
    'or': '或者',
    'origin': '起始地',
    'origin-placeholder': '起始地? - 地址或者车站',
    'own-position': '你当前的位置',
    'page-not-found': '找不到该页面.',
    'park-and-ride': '停和骑',
    'park-and-ride-availability': '有位置',
    'pay-attention': 'N.B.',
    'pick-icon': '选择图标',
    'place-route-or-keyword': '目的地，路线或停靠点',
    'platform-num': '站台 {platformCode}',
    'platform-short': '站',
    'prefer-walking': '倾向走路',
    'previous': '之前',
    'print': '打印',
    'realtime-matching': '实时集成',
    'rent-cycle-at': '在{station}车站租一辆自行车',
    'required-ticket': '旅程所需车票',
    'right-now': '马上',
    'route': '路线',
    'route-destination-arrives': '到达／终点站',
    'route-from-here': '从这里出发',
    'route-here': '这里的路线',
    'route-not-possible': '不辛的是，你的路线不可用， 技术错误："{error}"',
    'route-page.description': '路线 {route_short_name} - {route_long_name}',
    'route-page.title': '路线 {route_short_name}',
    'route-page.title-short': '路线',
    'route-stop-or-keyword': '关于路线或车站',
    'routes': '路线',
    'run': '运行',
    'save': '保存',
    'search': '搜索',
    'search-destination-results-but-no-search': '在相邻的“目的地”标签中查看结果',
    'search-no-results': '没有找到地址',
    'search-position': '检测位置',
    'search-search-results-but-no-destination': '在相邻的“关于路线或车站”标签中查看结果',
    'searching-position': '检测位置...',
    'select-position': '从你以前的搜索中选择你的地址',
    'send': '发送',
    'settings': '设置',
    'settings-reset': '重新设置',
    ...
    'share': '分享行程',
    'show-departures': '显示出发',
    'show-more': '显示更多',
    'skip-positioning': '跳过',
    'slow': '慢',
    'specify-location': '指定位置',
    'splash-geolocation-denied-message': '你尚未启用位置服务，你可以在浏览器或电话设置中启用位置服务。',
    'splash-geolocation-not-supported-message': '你的浏览器不支持位置检索。',
    'splash-geolocation-prompt-message': '接受浏览器访问你的位置的请求。',
    'splash-geolocation-watch-timeout-message': '检测你的位置时间比预期的要长，你是否已接受浏览器访问你的位置的请求？',
    'splash-locating': '检测位置',
    'splash-or-choose': '或选择你的起始地',
    'splash-please-allow-positioning': '为了充分利用服务，启用定位服务。',
    'splash-use-positioning': '使用定位服务',
    'splash-welcome': '你希望如何开始?',
    'splash-you-can-also': '或者',
    'stop': '车站',
    'stop-number': '站号',
    'stop-page.description': '车站 {stop_name} - {stop_code}',
    'stop-page.title': '车站 {stop_name} - {stop_code}',
    'stop-page.title-short': '车站',
    'stops': '车站',
    'subway-with-route-number': '地铁 {routeNumber} {headSign}',
    'terminal-page.description': '终点站 {stop_name}',
    'terminal-page.title': '终点站 {stop_name}',
    'terminal-page.title-short': '终点站',
    'terms-of-use': '使用条款',
    'ticket-and-price-info': '票和价钱信息',
    'tickets': '票',
    'time': '时间',
    'timetable': '时刻表',
    'to-stop': '去车站',
    'today': '今天',
    'tomorrow': '明天',
    'train-with-route-number': '火车 {routeNumber} {headSign}',
    'tram-with-route-number': '电车 {routeNumber} {headSign}',
    'transfers': '换乘次数',
    'transfers-allowed': '允许换乘',
    'transfers-margin': '至少要换乘',
    'trip-co2-emissions': '旅程的二氧化碳排放',
    'trip-page.description': '路线 {route_short_name} - {route_long_name}',
    'trip-page.title': '路线 {route_short_name}',
    'use-citybike': '开始使用',
    'use-own-position': '使用当前位置',
    'using-modes': '我想去旅行',
    'very-likely': '很喜欢',
    'very-unlikely': '很不喜欢',
    'via-point': '通过点',
    'wait-amount-of-time': '等{duration}',
    'walk-distance-duration': '走路{distance} ({duration})',
    'walking': '行走量',
    'walking-speed': '步行速度',
    'warning-call-agency': '按需路线： {routeName}, 需要提前预定。',
    'warning-call-agency-no-route': '按需路线，需要提前预定。',
    'weather-at-destination': '目的地的天气',
    'yesterday': '昨天',
    'your-favourites': '收藏夹',
    'zones': '票价区',
  },
